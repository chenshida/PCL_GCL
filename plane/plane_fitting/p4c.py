...
from plane.plane_fitting.svd_solve import svd_solve, svd
import matplotlib.pyplot as plt
from mpl_toolkits.mplot3d import Axes3D
# from fit_plane_LSE import fit_plane_LSE, fit_plane_LSE_RANSAC
from plane.plane_fitting.fit_plane_LSE import fit_plane_LSE, fit_plane_LSE_RANSAC

points_file = open('/home/pi/PycharmProjects/MyProject/plane/res/input/plane1.txt', 'r')
